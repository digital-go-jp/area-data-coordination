# [公共データ利用規約 第1.0版 (PDL 1.0)](https://www.digital.go.jp/resources/open_data/public_data_license_v1.0)  
...
### 1.3. 個別法令による利用の制約があるコンテンツについて("This Content" where use is restricted by specific laws and ordinances)
